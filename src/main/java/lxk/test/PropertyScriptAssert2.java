...
@Target({TYPE})
@Retention(RUNTIME)
@Constraint(validatedBy = {PropertyScriptAssert2.PropertyScriptAssertValidator.class})
@Documented
public @interface PropertyScriptAssert2 {
    ...
    public @interface List {
        ...
        PropertyScriptAssert2[] value();
    }

    class PropertyScriptAssertValidator implements ConstraintValidator<PropertyScriptAssert2, Object> {
        ...
        @Override
        public void initialize(PropertyScriptAssert2 constraintAnnotation) {
        ...
        private void validateParameters(PropertyScriptAssert2 constraintAnnotation) {
