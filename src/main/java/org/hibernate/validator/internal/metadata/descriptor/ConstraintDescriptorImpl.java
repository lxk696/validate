...
public class ConstraintDescriptorImpl<T extends Annotation> implements ConstraintDescriptor<T>, Serializable {
     ...
     */
    private static final List<String> NON_COMPOSING_CONSTRAINT_ANNOTATIONS = Arrays.asList(Documented.class.getName(), Retention.class.getName(), Target.class.getName(),
                    Constraint.class.getName(), ReportAsSingleViolation.class.getName());
     ...
     */
    private final Set<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?>> composingConstraints;
    ...
    public ConstraintDescriptorImpl(ConstraintHelper constraintHelper, Member member, T annotation, ElementType type, Class<?> implicitGroup, ConstraintOrigin definedOn,
                    org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType externalConstraintType) {
        ...
        List<Class<? extends ConstraintValidator<T, ?>>> crossParameterValidatorClasses = constraintHelper.findValidatorClasses(annotationType, ValidationTarget.PARAMETERS);
        List<Class<? extends ConstraintValidator<T, ?>>> genericValidatorClasses = constraintHelper.findValidatorClasses(annotationType, ValidationTarget.ANNOTATED_ELEMENT);
        ...
        this.constraintType = determineConstraintType(annotation.annotationType(), member, type, !genericValidatorClasses.isEmpty(), !crossParameterValidatorClasses.isEmpty(),
        ...
        if (constraintType == org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType.GENERIC) {
    ...
    public ConstraintDescriptorImpl(ConstraintHelper constraintHelper, Member member, T annotation, ElementType type,
                    org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType constraintType) {
    ...
    public Set<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?>> getComposingConstraintImpls() {
    ...
    public boolean equals(Object o) {
        ...
        org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?> that =
                        (org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?>) o;
     ...
     */
    private org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType determineConstraintType(
                    Class<? extends Annotation> constraintAnnotationType, Member member, ElementType elementType, boolean hasGenericValidators, boolean hasCrossParameterValidator,
                    org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType externalConstraintType) {
        ConstraintTarget constraintTarget = (ConstraintTarget) attributes.get(ConstraintHelper.VALIDATION_APPLIES_TO);
        org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType constraintType = null;
        ...
        if (constraintTarget == ConstraintTarget.RETURN_VALUE) {
            if (!isExecutable) {
                throw log.getParametersOrReturnValueConstraintTargetGivenAtNonExecutableException(annotationType.getName(), ConstraintTarget.RETURN_VALUE);
            }
            constraintType = org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType.GENERIC;
        }
        //target explicitly set to PARAMETERS
        else if (constraintTarget == ConstraintTarget.PARAMETERS) {
            if (!isExecutable) {
                throw log.getParametersOrReturnValueConstraintTargetGivenAtNonExecutableException(annotationType.getName(), ConstraintTarget.PARAMETERS);
            }
            constraintType = org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType.CROSS_PARAMETER;
        }
        ...
        //target set to IMPLICIT or not set at all
            ...
            if (hasGenericValidators && !hasCrossParameterValidator) {
                ...
                if (supportedValidationTarget.value().length == 1) {
                    constraintType = supportedValidationTarget.value()[0] == ValidationTarget.ANNOTATED_ELEMENT
                                    ? org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType.GENERIC
                                    : org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType.CROSS_PARAMETER;
                }
            }
        ...
        if (constraintType == org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType.CROSS_PARAMETER) {
    ...
    private void validateCrossParameterConstraintType(Member member, boolean hasCrossParameterValidator) {
        if (!hasCrossParameterValidator) {
            ...
            throw log.getCrossParameterConstraintOnMethodWithoutParametersException(annotationType.getName(), member.toString());
        }
    }
    ...
    private void validateComposingConstraintTypes() {
        for (org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?> composingConstraint : composingConstraints) {
            if (composingConstraint.constraintType != constraintType) {
                throw log.getComposedAndComposingConstraintsHaveDifferentTypesException(annotationType.getName(), composingConstraint.annotationType.getName(), constraintType,
    ...
    private Set<Class<?>> buildGroupSet(Class<?> implicitGroup) {
        ...
        final Class<?>[] groupsFromAnnotation = run(GetAnnotationParameter.action(annotation, ConstraintHelper.GROUPS, Class[].class));
    ...
    private Map<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper, Map<String, Object>> parseOverrideParameters() {
        Map<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper, Map<String, Object>> overrideParameters = newHashMap();
    ...
    private void addOverrideAttributes(Map<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper, Map<String, Object>> overrideParameters,
                    Method m, OverridesAttribute... attributes) {
        Object value = run(GetAnnotationParameter.action(annotation, m.getName(), Object.class));
        for (OverridesAttribute overridesAttribute : attributes) {
            ensureAttributeIsOverridable(m, overridesAttribute);

            org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper wrapper =
                            new org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper(overridesAttribute.constraint(),
    ...
    private Set<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?>> parseComposingConstraints(Member member, ConstraintHelper constraintHelper,
                    org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType constraintType) {
        Set<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?>> composingConstraintsSet = newHashSet();
        Map<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper, Map<String, Object>> overrideParameters = parseOverrideParameters();
        ...
        for (Annotation declaredAnnotation : annotationType.getDeclaredAnnotations()) {
            ...
            if (constraintHelper.isConstraintAnnotation(declaredAnnotationType)) {
                org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?> descriptor = createComposingConstraintDescriptor(member, overrideParameters,
                                OVERRIDES_PARAMETER_DEFAULT_INDEX, declaredAnnotation, constraintType, constraintHelper);
                ...
                for (Annotation constraintAnnotation : multiValueConstraints) {
                    org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<?> descriptor =
                                    createComposingConstraintDescriptor(member, overrideParameters, index, constraintAnnotation, constraintType, constraintHelper);
                    composingConstraintsSet.add(descriptor);
                    log.debugf("Adding composing constraint: %s.", descriptor);
                    index++;
                }
    ...
    private <U extends Annotation> org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<U> createComposingConstraintDescriptor(Member member,
                    Map<org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper, Map<String, Object>> overrideParameters, int index,
                    U constraintAnnotation, org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ConstraintType constraintType,
        ...
        AnnotationDescriptor<U> annotationDescriptor = new AnnotationDescriptor<U>(annotationType, buildAnnotationParameterMap(constraintAnnotation));

        // get the right override parameters
        Map<String, Object> overrides =
                        overrideParameters.get(new org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper(annotationType, index));
        if (overrides != null) {
        ...
        return new org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl<U>(constraintHelper, member, annotationProxy, elementType, null, definedOn,
                        constraintType);
    }
    ...
    private class ClassIndexWrapper {
        ...
        public boolean equals(Object o) {
            ...
            org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper that =
                            (org.hibernate.validator.internal.metadata.descriptor.ConstraintDescriptorImpl.ClassIndexWrapper) o;
